...
def lambda_handler(request, context):
    ...
    insert = {}    
    insert['meeting_info'] = insertTransactions
    
    #delete = {}
    #delete['meeting_info'] = deleteTransactions
    ...
    schema = {}
    schema['meeting_info'] = transactionsSchema
...
def api_response(state, secrets):
    ...
    apiCall = requests.get("http://35.abc.def.204/getMeetingsTableAll", params=Input) #URL is not shown
    print(apiCall)
